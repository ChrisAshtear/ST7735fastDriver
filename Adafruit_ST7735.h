...
class Adafruit_ST7735 : public Adafruit_GFX {
 ...
 public:
  ...
  void     initB(void),                             // for ST7735B displays
		   ...
		   drawFastColorBitmap(int16_t x, int16_t y, const uint8_t bitmap[], int16_t w, int16_t h, const uint8_t colorIndex[], const uint16_t pal[], uint16_t bg)/*DRAWS STANDALONE BITMAP. IF DRAWING TILES USE */,
		   ...
		   drawSurface(int16_t x, int16_t y, const uint8_t bitmap[], int16_t w, int16_t h, uint16_t color,uint16_t bg)/*MUST USE START/END DRAW WITH THIS*/,
		   endDraw(),
